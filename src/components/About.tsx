...
const About = () => {
    ...
    return (
        <>
            <div id='about' className='flex justify-center items-center min-h-[850px] rounded-3xl mt-28 md:py-6 md:mt-32 lg:py-20 lg:h-fit lg:min-h-fit xl:h-[850px] 3xl:min-h-[580px]'>
